...
## Prerequisites
### AWS Setup
Most of used resources fall into the free-tier. Some IOT components are not included into the free tier, so you could be charged for consumption, but as soon as the solution is used for personal purpose the overall coss is very tiny (in my experience is about 0.1$  per month).
